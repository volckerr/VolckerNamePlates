...
function mod:CreateComboPoints(msg, frame)
	...
	for i = 0, 4 do
		...
		cp:SetTexture("Interface\\AddOns\\VolckerNamePlates\\Media\\combopoint-round")
		...
		glow:SetTexture("Interface\\AddOns\\VolckerNamePlates\\Media\\combopoint-glow")
...
function mod:OnEnable()
	self:RegisterMessage("VolckerNamePlates_PostCreate", "CreateComboPoints")
	self:RegisterMessage("VolckerNamePlates_PostHide", "HideComboPoints")
	self:RegisterMessage("VolckerNamePlates_PostTarget", "OnFrameTarget")
