...
function mod:OnEnable()
	self:RegisterMessage("VolckerNamePlates_GUIDAssumed", "GUIDAssumed")
	self:RegisterMessage("VolckerNamePlates_GUIDStored", "GUIDAssumed")
	self:RegisterMessage("VolckerNamePlates_PostShow", "PostShow")
	self:RegisterMessage("VolckerNamePlates_PostHide", "PostHide")
end
function mod:OnDisable()
	self:UnregisterMessage("VolckerNamePlates_GUIDAssumed")
	self:UnregisterMessage("VolckerNamePlates_GUIDStored")
	self:UnregisterMessage("VolckerNamePlates_PostShow")
	self:UnregisterMessage("VolckerNamePlates_PostHide")
end