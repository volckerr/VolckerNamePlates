local L = LibStub("AceLocale-3.0"):NewLocale("VolckerNamePlates", "enUS", true)
...
L["Move the base nameplate placement up or down. On patched clients this also affects the default click-box position."] = true
...
L["Target alpha"] = true
L["The alpha value used by your current target's nameplate."] = true
